...
if user_input == 1: #The first If Statement for Hard Liquor
    ...
    if num1 == 1:#The nested if statement under Hard Liquor
        ...
        print(num1) 
elif user_input == 2:#The first Elif Statement for Red Wine
    ...
    if num1 == 1:#The nested if statement under Red Wine
        ...
        print("Invalid Number")#If the Number Invalid this message will appear
        print(num1)
elif user_input == 3:#The first Elif Statement for White Wine
    ...
    if num1 == 1:#The nested if statement under White Wine
        ...
        print("Invalid Number")#If the Number Invalid this message will appear
        print(num1)  
elif user_input == 4:#The first Elif Statement for Beer
